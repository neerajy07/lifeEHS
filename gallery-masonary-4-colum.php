...
<!-- Mirrored from validthemes.net/site-template/medihub/gallery-masonary-4-colum.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2024 09:17:41 GMT -->
<head>
    <!-- ========== Meta Tags ========== -->
    <meta charset="utf-8">
                            ...
                            <div id="portfolio-grid" class="gallery-items col-4">
                                ...
                                <div class="pf-item consulting finance">
                                    <div class="effect-box">
                                        ...
                                        <div class="info">
                                          <h4><a href="#">Empire State</a></h4>
                                          <a href="assets/img/gallery/7.jpg" class="item popup-link"><i class="fa fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Item -->
