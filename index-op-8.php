...
<!-- Mirrored from validthemes.net/site-template/medihub/index-op-8.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2024 09:17:38 GMT -->
<head>
    <!-- ========== Meta Tags ========== -->
    <meta charset="utf-8">
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="#" data-out="#">
                        ...
                        <li>
                            <a class="smooth-menu" href="#appoinment">Appoinment</a>
                        </li>
                        <li>
                            <a class="smooth-menu" href="#services">Services</a>
                        </li>
                        <li>
                            <a class="smooth-menu" href="#tips">Health Tips</a>
                        </li>
                        <li>
                        ...
                        <div class="row">
                            <div class="content double-items">
                                ...
                                <div class="col-md-5 col-sm-6 thumb">
                                    <img src="assets/img/banner/s4.jpg" alt="Thumb">
                                </div>
    ...
    <!-- Start Appoinment
    ============================================= -->
    <div id="appoinment" class="appoinment-area default-padding bg-cover" style="background-image: url(assets/img/banner/17.jpg);">
        <div class="container">
            <div class="row">
    ...
    <!-- Start Services 
    ============================================= -->
    <div id="services" class="services-area inc-icon carousel-shadow default-padding bottom-less">
        <div class="container">
            <div class="row">
    ...
    <!-- Start Fun Factor
    ============================================= -->
    <div class="fun-fact-area default-padding shadow light text-center bg-fixed text-light" style="background-image: url(assets/img/banner/7.jpg);">
        <div class="container">
            <div class="row">
