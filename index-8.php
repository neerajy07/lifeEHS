...
<!-- Mirrored from validthemes.net/site-template/medihub/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2024 09:17:34 GMT -->
<head>
    <!-- ========== Meta Tags ========== -->
    <meta charset="utf-8">
...
<body>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 thumb">
                                        <img src="assets/img/banner/s1.jpg" alt="Thumb">
                                    </div>
                    ...
                    <div class="box-table">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 thumb">
                                        <img src="assets/img/banner/s2.jpg" alt="Thumb">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <div class="content">
                    ...
                    <div class="box-table">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 thumb">
                                        <img src="assets/img/banner/s3.jpg" alt="Thumb">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <div class="content">
    ...
    <!-- Start Video BG 
    ============================================= -->
    <div class="video-bg-area text-center shadow dark text-light video-bg-live bg-fixed" style="background-image: url(assets/img/banner/14.jpg);">
...
<!-- Mirrored from validthemes.net/site-template/medihub/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2024 09:17:36 GMT -->
</html>